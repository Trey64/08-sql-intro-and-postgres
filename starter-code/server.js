...
app.get('/new', function(request, response) {
  ...
  // 5. sending a response to the view from the server. doesn't interact with article.js. Part of CRUD: Read.
...
app.get('/articles', function(request, response) {
  // COMMENT: DONE What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 3, 4 5. Article.fetchAll. Part of CRUD: Read.
...
app.post('/articles', function(request, response) {
  // COMMENT: DONE What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 2, 3 , 5. Article.prototype.InsertRecord. Part of CRUD: Create.
  client.query(
    `INSERT INTO
...
app.put('/articles/:id', function(request, response) {
  // COMMENT: DONE What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 2, 3, 5. Article.prototype.updateRecord. Part of CRUD: Update.
  client.query(
    `UPDATE articles
    SET
...
app.delete('/articles/:id', function(request, response) {
  // COMMENT: DONE What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 2, 3, 5. Article.prototype.deleteRecord. Part of CRUD: Destroy.
  client.query(
...
app.delete('/articles', function(request, response) {
  // COMMENT: DONE What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 2, 3, 5. Article.truncateTable. Part of CRUD: Destroy.
  client.query(
...
// Create database table template when one doesn't exist.
loadDB();
...
function loadDB() {
  // COMMENT: DONE What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // 3. Doesn't interact with article.js. Part of CRUD: Create.
  client.query(`
